...
public abstract class Plot implements ChartElement, AxisChangeListener,
    ...
    protected Plot() {
        ...
        this.notify = true;
        plotProduct3.getPlotProduct2().setListenerList(new EventListenerList());
    }
    ...
    public void addChangeListener(PlotChangeListener listener) {
        plotProduct3.getPlotProduct2().addChangeListener(listener);
    }
    ...
    public void removeChangeListener(PlotChangeListener listener) {
        plotProduct3.getPlotProduct2().removeChangeListener(listener);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
		...
		clone.plotProduct3.setPlotProduct2((PlotProduct2) this.plotProduct3.getPlotProduct2().clone());
        ...
        clone.plotProduct3.getPlotProduct2().setListenerList(new EventListenerList());
        return clone;
    }
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
		...
		stream.writeObject(this.plotProduct3.getPlotProduct2());
    ...
    private void readObject(ObjectInputStream stream)
		...
		plotProduct3.setPlotProduct2((PlotProduct2) stream.readObject());
