...
public class PolarPlotProduct2 implements Serializable, Cloneable {
	...
	public double normalizedAngle(double angleDegrees) {
	...
	*/
	...
	public Rectangle2D dataArea(PolarAxisLocation location, Rectangle2D plotArea) {
	...
	*/
	public TextAnchor calculateTextAnchor(double angleDegrees) {
		...
		double normalizedAngle = normalizedAngle(angleDegrees);
