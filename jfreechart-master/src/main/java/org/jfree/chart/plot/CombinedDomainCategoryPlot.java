...
public class CombinedDomainCategoryPlot extends CategoryPlot
    ...
    @Override
     public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor,
        ...
        for (int i = 0; i < this.subplots.size(); i++) {
            ...
            plot(g2, anchor, parentState, i, plot, subplotInfo);
        }
	...
	private void plot(Graphics2D g2, Point2D anchor, PlotState parentState, int i, CategoryPlot plot,
			PlotRenderingInfo subplotInfo) {
